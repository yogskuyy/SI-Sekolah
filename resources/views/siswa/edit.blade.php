            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="{{route('siswa.create')}}" class="btn btn-primary mb-3">Input Data</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="id_kelas" id="id_kelas" class="form-control">
                                                ...
                                                @foreach ($kelas as $kls)
                                                    <option value="{{ $kls->id_kelas }}"{{ $siswa->id_kelas == $kls->id_kelas ? 'selected' : '' }}>{{ $kls->id_kelas }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="mb-3">
                      <label for="tanggal_lahir" class="form-label">Tanggal tanggal_lahir</label>
                    ...
                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="id_ekstra" class="form-control-label">Id Kelas</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <select name="id_ekstra" id="id_ekstra" class="form-control">
                                                <option value="">Pilih</option>
                                                @foreach ($ekstra as $kls)
                                                    <option value="{{ $kls->id_ekstrakurikuler }}"{{ $siswa->id_ekstrakurikuler == $kls->id_ekstrakurikuler ? 'selected' : '' }}>{{ $kls->id_ekstrakurikuler }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
