...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('ekstrakurikuler.index')}}">EKSTRAKURIKULER</a>
...
<li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('walimurid.index')}}">WALIMURID</a>
        </div>
    </div>
</li>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <a href="{{route('walimurid.create')}}" class="btn btn-primary mb-3">Input Data</a>
                                    </div>
                                    <div class="card-body">
                            ...
                            <form action="{{ route('walimurid.update',$walimurid->id_walimurid)}}" method="POST">
                                ...
                                <div class="mb-3">
                                    <div class="col col-md-3">
                                        <label for="id_siswa" class="form-control-label">ID Siswa</label>
                                    </div>
                                    <select name="id_siswa" id="id_siswa" class="form-control">
                                        <option value="">Pilih</option>
                                        @foreach ($siswa as $sw)
                                            <option value="{{ $sw->id_siswa }}{{ $sw->id_walimurid == $sw->id_siswa ? 'selected' : '' }}">{{ $sw->id_siswa }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                            </div>
                                            <div class="mb-3">
                                  <label for="nama_walimurid" class="form-label">Nama Walimurid</label>
                                  <input type="text" class="form-control" name="nama_walimurid" id="nama_walimurid" value="{{ $walimurid->nama_walimurid }}">
                                </div>
                                            <div class="mb-3">
                                                <label for="alamat" class="form-label">Alamat</label>
                                  <input type="text" class="form-control" name="alamat" id="alamat" value="{{ $walimurid->alamat }}">
                                </div>
                                <div class="mb-3">
                                    <label for="no_hp" class="form-label">No Hp</label>
                                    <input type="text" class="form-control" name="no_hp" id="no_hp" value="{{ $walimurid->no_hp }}">
                                </div>
                                <div class="mb-3">
                                    <label for="keterangan" class="form-label">Keterangan</label>
                                    <input type="text" class="form-control" name="keterangan" id="keterangan" value="{{ $walimurid->keterangan }}">
                                </div>
