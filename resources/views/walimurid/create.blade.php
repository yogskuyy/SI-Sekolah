                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            <form action="{{ route('walimurid.store') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label for="id_walimurid" class="form-label">ID Walimurid</label>
                                    <input type="text" class="form-control" name="id_walimurid" id="id_walimurid" >
                                </div>
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" name="nama_walimurid" id="nama_walimurid" >
                                </div>
                                            <div class="mb-3">
